...
const (
	PaymentService_Charge_FullMethodName = "/proto.PaymentService/Charge"
	PaymentService_Refund_FullMethodName = "/proto.PaymentService/Refund"
	PaymentService_Status_FullMethodName = "/proto.PaymentService/Status"
)
...
func (c *paymentServiceClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPaymentServiceServer) Status(context.Context, *StatusRequest) (*StatusResponse, error) {
...
func _PaymentService_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Status(ctx, req.(*StatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
